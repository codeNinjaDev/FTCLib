...
public class Pixy2Line {
    ...
    public byte getAllFeatures() {
        return update(LINE_GET_ALL_FEATURES, LINE_ALL_FEATURES, true);
    }
    ...
    public byte getMainFeatures() {
        return update(LINE_GET_MAIN_FEATURES, LINE_ALL_FEATURES, true);
    }
     ...
     * @return Pixy2 error code
     */
    public byte update(byte type, byte features, boolean wait) {
        byte res;
